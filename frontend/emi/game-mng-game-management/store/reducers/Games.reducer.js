...
const gamesReducer = function (state = initialState, action) {
    switch (action.type) {
        ...
        case Actions.SET_GAMES_ROWS_PER_PAGE:
            {
                return {
                    ...state,
        ...
        case Actions.SET_GAMES_FILTERS_ORGANIZATION_ID:
            {
                return {
                    ...state,
        ...
        case Actions.SET_GAMES_FILTERS_NAME:
            {
                return {
                    ...state,
        ...
        case Actions.SET_GAMES_FILTERS_ACTIVE:
            {
                return {
                    ...state,

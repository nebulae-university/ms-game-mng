...
module.exports = {
    ...
    //// QUERY ///////
    Query: {
        GameMngGameListing(root, args, context) {
            return sendToBackEndHandler$(root, args, context, READ_ROLES, 'query', 'Game', 'GameMngGameListing').toPromise();
        },
        ...
        GameMngGameStatistics(root, args, context) {
            return sendToBackEndHandler$(root, args, context, READ_ROLES, 'query', 'Game', 'GameMngGameStatistics').toPromise();
        }
    },
    ...
    Mutation: {
        ...
        GameMngDeleteGames(root, args, context) {
            return sendToBackEndHandler$(root, args, context, WRITE_ROLES, 'mutation', 'Game', 'GameMngDeleteGames').toPromise();
        },
    },
        ...
        GameMngGameModified: {
            subscribe: withFilter(
                (payload, variables, context, info) => {
                    ...
                    return pubsub.asyncIterator("GameMngGameModified");
                },
                (payload, variables, context, info) => {
                    return payload
                        ? (payload.GameMngGameModified.id === variables.id) || (variables.id === "ANY")
                        : false;
                }
            )
        }
...
const eventDescriptors = [
    {
        backendEventName: "GameMngGameModified",
        gqlSubscriptionName: "GameMngGameModified",

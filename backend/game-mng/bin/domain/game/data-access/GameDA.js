...
class GameDA {
   ...
   */
  static getGame$(id, organizationId) {
  ...
  static getGameList$(filter = {}, pagination = {}, sortInput) {
    const collection = mongoDB.db.collection(CollectionName);
  ...
  * creates a new Game 
  * @param {*} id Game ID
  * @param {*} Game properties
  */
  static createGame$(_id, properties, createdBy) {
  ...
  /**
  * modifies the Game properties
  * @param {String} id  Game ID
  * @param {*} Game properties to update
  */
  static updateGame$(_id, properties, updatedBy) {
    const collection = mongoDB.db.collection(CollectionName);
    return defer(() =>
  ...
  * @param {*} Game properties to update
  */
  static updateGameFromRecovery$(_id, properties, av) {
    const collection = mongoDB.db.collection(CollectionName);
    return defer(() =>
  ...
  * @param {*} Game properties to update
  */
  static replaceGame$(_id, properties) {
    const collection = mongoDB.db.collection(CollectionName);
    return defer(() =>
  ...
  */
  ...
  /**
    * deletes multiple Game at once
    * @param {*} _ids  Game IDs array
  */
  static deleteGames$(_ids) {
    const collection = mongoDB.db.collection(CollectionName);
    return defer(() =>

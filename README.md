...
![Intro](docs/images/ms-game-mng_intro.png "Intro")
# Table of Contents
  ...
  * [BackEnd](#backend)
    *  [game-mng](#backend_game-mng)
        * [Environment variables](#backend_game-mng_env_vars)
        * [Event Sourcing](#backend_game-mng_eventsourcing)
        * [CronJobs](#backend_game-mng_cronjobs)
...
│   ├── game-mng                     => Micro-BackEnd responsible for ...
...
Note: You may find the GraphQL schema [here](api/emi-gateway/graphql/game-mng/schema.gql)
...
#### game-mngHelloWorldSubscription
...
## game-mng <a name="backend_game-mng"></a>
...


### Environment variables <a name="backend_game-mng_env_vars"></a>
...
```
#### Notes: 
  * ENV VARS for development are [here](backend/game-mng/.env)
  * ENV VARS for production are [here](deployment/gke/deployment-game-mng.yaml)

### Event Sourcing <a name="backend_game-mng_eventsourcing"></a>
...
### CronJobs <a name="backend_game-mng_cronjobs"></a>
...
### 1. clone this repo  
   ```git clone https://github.com/nebulae-university/ms-game-mng.git```  
...
### 5. Compose FrontEnd
```
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://github.com/nebulae-university/emi --frontend-id=emi --output-dir=/FULL_PATH_TO_REPO/ms-game-mng/playground/emi  --setup-file=/FULL_PATH_TO_REPO/ms-game-mng/etc/mfe-setup.json
```

### 6. Compose the API emi-gateway
```
nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-university/emi-gateway --api-id=emi-gateway --output-dir=FULL_PATH_TO_REPO/ms-game-mng/playground/emi-gateway  --setup-file=FULL_PATH_TO_REPO/ms-game-mng/etc/mapi-setup.json
```
...
* set this key value to the **JWT_PUBLIC_KEY** atribute in the following files: *WORKING_FOLDER*/ms-game-mng/backend/game-mng/.env   *WORKING_FOLDER*/ms-game-mng/playground/emi-gateway/.env  
